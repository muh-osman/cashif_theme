                ...
                <div class="login-btn-box">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu unset-three-dot-ul">
                            <li>
                                <a style="display: flex;" class="dropdown-item" href="https://cashif.cc/check-it/">
            ...
            <div class="left-new-serv">
                ...
                <div class="stage">
                    ...
                    <div>
                        ...
                        <h6>You can download the inspection report through <a id="ask-now-btn" href="https://cashif.cc/dashboard/reports">our website</a> and see the actual condition of the car</h6>
                    </div>
                </div>
    ...
    <nav class="mob-phone-nav">
        <div class="navigation">
            <ul>
                ...
                <li id="report-nav" class="list category-btn-in-mob-nav" aria-label="Reports" title="Reports">
