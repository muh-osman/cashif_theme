            ...
            <div class="intro-content">
                <div class="discount-details">
                    <h6 class="first-title">
                        <span>
                            حصلت سيارة للبيع وأنت خارج الرياض أو الدمام؟
                        </span>
                    </h6>
                    <h6 class="mt-0">
                        كاشف يفحصها عنك ويشحنها لك
                    </h6>
                </div>
        ...
        <div class="two-box-box">
            ...
            <div class="right-new-serv">
                ...
                <div class="stage">
                    ...
                    <div>
                        <h3>التواصل مع صاحب السيارة</h3>
                        <h6>نقوم بالتواصل مع صاحب السيارة, وتحديد الموعد المناسب</h6>
                    </div>
                </div>
            ...
            <div class="left-new-serv">
                ...
                <div class="stage">
                    ...
                    <div>
                        ...
                        <h6>نرسل لك تقريًرا شاملا يتضمن كل الملاحظات والتوصيات بخصوص حالة السيارة</h6>
                    </div>
                </div>
                ...
                <div class="stage">
                    ...
                    <div>
                        <h3>شحن السيارة</h3>
                        <h6>بالتعاون مع شركائنا، نوفر خدمة شحن السيارة لمدينتك بكل أمان</h6>
                    </div>
                </div>
            </div>
...
الهيكل السفلي: التحقق من عدم وجود أي صدأ أو تلف في الهيكل السفلي">
    ...
    <a aria-label="WhatsApp Customer Service" class="sticky-icon" target="_blank" href="https://api.whatsapp.com/send?phone=966536181188&text=*أرغب بالتحدث مع خدمة العملاء*">
