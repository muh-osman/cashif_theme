    ...
    <div class="white-background">
        ...
        <div class="table-container">
            ...
            <div class="box">
                ...
                <!-- Redeeme Banner -->
                <div id="redeeme-banner" class="redeeme-banner text-center">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr id="row-redeeme" style="display: none;">
                                ...
                                <td dir="rtl" class="border-top border-bottom-0" style="border-color: #ececec !important; text-align: left !important;">
