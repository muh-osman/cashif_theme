...
<body>
    ...
    <div id="thanks-box" class="thanks-box">
        ...
        <h4 class="mt-4 text-center">قم بحفظ الباركود، لإبرازه لموظف الاستقبال في الفرع المحدد لإتمام إجراءات الفحص.</h4>
        ...
        <div class="partner-container">
            <h2>خصم خاص <span>لعملاء كاشف!</span></h2>
    ...
    <div id="error-box" class="error-box">
        ...
        <h3 class="mt-3 text-center">خطأ في الدفع</h3>
        <a class="mr-auto mt-3 text-center d-block" href="https://cashif.cc/">عودة</a>
    </div>
