            ...
            <div>
                <div class="table-container">
                    ...
                    <div class="box">
                        ...
                        <!-- Redeem Banner -->
                        <div id="redeeme-banner" class="redeeme-banner" dir="ltr" style="text-align: center;">
                        ...
                        <div class="table-box">
                            ...
                            <table dir="ltr" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border-0">
                                            <input class="me-1 form-check-input control-table checked-input" type="checkbox" value="Car photography (video + photos)" id="reverseCheck1" data-row="row-video">
                                            <label class="form-check-label small-text-in-small-screeen" for="reverseCheck1">
                                                Car photography (video + photos)
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="border-0">
                                            <input class="me-1 form-check-input control-table checked-input" type="checkbox" value="Explanation the report via video" id="reverseCheck2" data-row="row-explain-report">
                                            <label class="form-check-label small-text-in-small-screeen" for="reverseCheck2">
                                                Explanation the report via video
                                            </label>
                                        </td>
