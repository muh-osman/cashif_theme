        ...
        <div class="container p-0">
            <div class="intro-content">
                ...
                <div class="login-btn-box">
                    <!-- <a href="https://cashif.cc/dashboard/login" target="_blank">دخول</a> -->
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu unset-three-dot-ul">
                            <li>
                                <a style="display: flex;" class="dropdown-item" href="https://cashif.cc/en/">
                    ...
                    <div class="service-card d-flex flex-column h-100">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span>تحميل تقرير الفحص عبر <a href="https://cashif.cc/dashboard/reports">موقعنا</a></span>
                            </li>
                            <li>
                                <span><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-119a5lz" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="VerifiedUserIcon">
                                        <path d="M12 1 3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"></path>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 col-6">
                            <div class="help-list">
                                ...
                                <ul>
                                    <li>
                                        <a href="#inspection-before-buying">فحص ما قبل الشراء</a>
                                    </li>
    ...
    <nav class="mob-phone-nav">
        <div class="navigation">
            <ul>
                ...
                <li class="list category-btn-in-mob-nav" aria-label="تقاريري" title="تقاريري">
